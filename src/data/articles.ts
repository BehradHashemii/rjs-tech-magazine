...
export const ARTICLES: Article[] = [
  {
    ...
    excerpt: 'اگر میان انبوهی از سوالات و نحوه کارکرد هوش مصنوعی و مدل های زبانی بزرگ گیر کرده اید جواب شما در این مقاله‌ست',
...
<section>
  ...
  <p><strong>۲. آموزش تکمیلی یا تراز کردن (Fine-tuning & RLHF)</strong><br />در مرحله RLHF، انسان‌ها به پاسخ‌های مدل امتیاز می‌دهند تا مدل یاد بگیرد دستیار مفید و مودب باشد.</p>
    ...
    coverImage: 'https://behradhashemii.ir/varia/images/what-is-ai-everything-you-need-know-about-artificial-intelligence.webp',
  ...
  },
  {
    ...
    excerpt: 'پایتون به عنوان زبان استاندارد و بدون رقیب در دنیای هوش مصنوعی و یادگیری ماشین شناخته می‌شود.',
...
<div>
  ...
  <p>پایتون یکی از محبوب‌ترین زبان‌های برنامه‌نویسی دنیاست و در زمینه هوش مصنوعی، بزرگ‌ترین جامعه برنامه‌نویسان را دارد.</p>
    ...
    categorySlug: 'tech',
    subcategorySlug: 'ai-articles',
    coverImage: 'https://behradhashemii.ir/varia/images/python-for-ai.webp',
    author: AUTHOR_BEHRAD,
  ...
  },
  {
    ...
    excerpt: 'چگونه فریم‌ورک Tailwind CSS مدیریت استایل در پروژه‌های مقیاس‌بزرگ فرانت‌اند را ساده و سریع می‌کند؟',
...
<p>Tailwind با ارائه سیستم طراحی استاندارد و حذف کلاس‌های استفاده نشده در مرحله Build، حجم فایل نهایی CSS را بسیار کوچک نگه می‌دارد.</p>`,
    ...
    coverImage: 'https://behradhashemii.ir/varia/images/tailwindcss.webp',
    author: AUTHOR_BEHRAD,
  ...
  },
  {
    ...
    excerpt: 'راهنمای جامع مدیریت نسخه پیشرفته شامل Stash, Rebase, Cherry-pick برای برنامه‌نویسان و تیم‌های نرم‌افزاری',
...
git cherry-pick a1b2c3d4</code></pre>`,
    categorySlug: 'howto',
    subcategorySlug: 'computer-learning',
    coverImage: 'https://behradhashemii.ir/varia/images/git-command.webp',
    author: AUTHOR_BEHRAD,
  ...
  },
  {
    ...
    excerpt: 'معرفی کاربردی‌ترین چت‌بات‌ها و دستیارهای هوش مصنوعی داخلی مثل زیگپ، گپ‌جی‌پی‌تی و روبو',
...
<p>سرویسی پردانلود با پشتیبانی از مدل‌های متنوع متنی و تصویرساز برای تولید محتوا و کدنویسی.</p>`,
    categorySlug: 'tech',
    subcategorySlug: 'ai-articles',
    coverImage: 'https://behradhashemii.ir/varia/images/ai-tools-692eb80b2017c0b719e16ce5.webp',
    author: AUTHOR_BEHRAD,
  ...
  },
  {
    ...
    excerpt: 'معرفی وب‌سایت‌ها و اپلیکیشن‌های پخش موسیقی فعال روی شبکه ملی اطلاعات',
...
<p>سرویس جستجو و پخش آنلاین موسیقی‌های ایرانی و بین‌المللی همراه با متن ترانه‌ها.</p>`,
    ...
    coverImage: 'https://behradhashemii.ir/varia/images/oneplus-13-music-player.webp',
    author: AUTHOR_BEHRAD,
  ...
  },
  {
    ...
    excerpt: 'جزئیات ادغام هوش مصنوعی در سیستم‌های جنگ الکترونیک و شناسایی هوشمند جنگنده F-35 لاکهید مارتین',
...
<p>جنگنده‌ی F-35 اطلاعات تهدیدها را مستقیماً روی کلاه ایمنی خلبان و نمایشگر عریض کابین نشان می‌دهد. مدل هوش مصنوعی ابهامات شناسایی میان فرستنده‌های سیگنال را برطرف کرده و آگاهی محیطی خلبان را افزایش می‌دهد.</p>`,
    ...
    coverImage: 'https://behradhashemii.ir/varia/images/ai-helping-f-35-spot-enemy-air-defenses.webp',
    author: AUTHOR_BEHRAD,
  ...
  },
  {
    ...
    excerpt: 'تحلیل شواهد و تغییر وضعیت رادارهای ابرآروان در اتصال به دیتاسنترهای خارجی',
...
<p>کارشناسان می‌گویند در حال حاضر به شکل وایت‌لیستی برخی سرویس‌ها و دامنه‌های خارجی در حال باز شدن در شبکه اینترنت کشور هستند که می‌تواند مقدمه بازگشایی شبکه باشد.</p>`,
    ...
    coverImage: 'https://api2.zoomit.ir/media/internet-connection2-63b52929745f73edafcd31cd?w=1200&q=80',
    author: {
      name: 'هانیه کلهر',
  ...
  },
  {
    ...
    excerpt: 'بررسی علل فنی قطعی سامانه‌های مهم و خطاهای SSL و DNS در دوران محدودیت‌های اینترنتی',
...
<p>به دلیل قطعی ارتباط با CDN‌های بین‌المللی مثل کلودفلر، آدرس‌دهی سرورها با اختلال مواجه می‌شود.</p>`,
    ...
    coverImage: 'https://api2.zoomit.ir/media/126-697772681f7be142ad6524bf?w=1080&q=80',
    author: AUTHOR_BEHRAD,
  ...
  },
  {
    ...
    excerpt: 'بررسی کامل مقررات ملی ساختمان (مبحث ۱۳)، محاسبات بار، ارتینگ، کلید محافظ جان و هوشمندسازی',
...
<p>سیستم ارتینگ با ایجاد مسیر کم‌مقاومت به زمین، از شوک الکتریکی جلوگیری می‌کند. کلید محافظ جان (RCCB) نیز نشتی جریان بالای ۳۰ میلی‌آمپر را در کسری از ثانیه قطع می‌کند.</p>`,
    categorySlug: 'science',
    subcategorySlug: 'engineering',
    coverImage: 'https://behradhashemii.ir/varia/images/2026-building-electrical-wiring-system.webp',
    author: AUTHOR_BEHRAD,
  ...
  },
  {
    ...
    excerpt: 'تکنیک‌های پیشرفته مهندسی پرامپت از جمله Few-Shot Prompting، Chain-of-Thought و ساخت دستورالعمل‌های سیستمی ساختاریافته',
...
<p>با رعایت این اصول، می‌توانید از مدل‌های پیشرفته نهایت بهره‌وری را کسب کنید.</p>`,
    ...
    comments: [
      {
        ...
        content: 'تکنیک زنجیره تفکر فوق‌العاده بود! روی پروژه خودم تست کردم پاسخش کاملا تغییر کرد.',
  ...
  },
  {
    ...
    excerpt: 'راهنمای قدم به قدم توسعه عامل‌های خودمختار با قابلیت فراخوانی ابزارها (Tool Calling)، حافظه کوتاه‌مدت و تصمیم‌گیری زنجیره‌ای',
...
<p>با ترکیب این ابزارها، عامل‌ها می‌توانند وظایف پیچیده اداری و فنی را خودکارسازی کنند.</p>`,
    ...
    comments: [
      {
        ...
        content: 'آموزش بسیار روانی بود. برای پروژه اتوماسیون شرکتمون ازش استفاده کردم.',
  ...
  },
  {
    ...
    title: 'تحلیل معماری RAG (تولید بازیابی‌افزوده): اتصال هوش مصنوعی به داده‌های سازمانی',
    excerpt: 'چگونه با استفاده از دیتابیس‌های برداری (Vector DB) و الگوریتم‌های چانکینگ، مشکل هالوژنیشن در مدل‌های زبانی بزرگ را حل کنیم؟',
...
<ul>
  ...
  },
  {
    ...
    title: 'آموزش جامع لینوکس برای توسعه‌دهندگان: فرمان‌های کلیدی، سرور و Bash Scripting',
    excerpt: 'راهنمای تسلط بر ترمینال لینوکس، مدیریت پروسه‌ها، تنظیمات شبکه و خودکارسازی وظایف با اسکریپت‌های باش',
...
echo "Backup created successfully at $DATE"</code></pre>`,
  ...
  },
  {
    ...
    title: 'هوش مصنوعی مولد ویدیو و تصویر: بررسی معماری فنی Sora، Veo 2 و Midjourney v7',
    excerpt: 'کالبدشکافی تکنولوژی مدل‌های پخش چندبعدی (Latent Diffusion) و ترنسفورمرهای ویدیویی در خلق تصاویر و ویدیوهای شبیه‌سازی فیزیکی',
...
<p>نسخه جدید Midjourney با کنترل کامل بر پرسپکتیو، نورپردازی واقعی استودیویی و پایبندی ۹۹ درصدی به متن ورودی، تحولی بزرگ در صنعت طراحی گرافیک و سینما ایجاد کرده است.</p>`,
    categorySlug: 'tech',
    subcategorySlug: 'ai-articles',
    coverImage: 'https://images.unsplash.com/photo-1633167606207-d840b5070fc2?q=80&w=1200&auto=format&fit=crop',
    author: AUTHOR_BEHRAD,
